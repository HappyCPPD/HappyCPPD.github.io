...
export const projects: Project[] = [
  ...
  },
  {
    ...
    links: [{ label: 'Source', href: 'https://github.com/HappyCPPD/AuthLogReader' }],
    featured: true,
  },
  {
    ...
    links: [{ label: 'Source', href: 'https://github.com/HappyCPPD/Subnet-Scanner' }],
    featured: true,
  },
  {
    title: 'LAN Chat Room',
    ...
    links: [{ label: 'Source', href: 'https://github.com/HappyCPPD/python-chat-room' }],
    featured: true,
  },
];
